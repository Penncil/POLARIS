...
This repository provides supplementary materials for the paper:  "Federated target trial emulation for time-to-event outcomes via MINT: Multi-site IPTW with teNsor train for Time-to-event Analysis "  including additional experiments, implementation details, simulation code, and supporting results that are not included in the main manuscript.
